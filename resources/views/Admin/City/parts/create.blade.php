...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('cities.store')}}">
    ...
    <div class="row mt-5">
        <div class="col-6">
            <input type="text" class="form-control" placeholder="خط الطول مثال : 24.815310807697905" name="latitude" id="lat">
        </div>
        <div class="col-6">
            <input type="text" class="form-control" placeholder="دائرة العرض مثال : 46.67454711582318" name="longitude" id="lng">
        </div>
    </div>
