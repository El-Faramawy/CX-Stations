...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('duets.store')}}">
    @csrf
    <div class="row mt-0">
        ...
        <x-form.input class="col-sm-6" title="تاريخ البداية " :required="true">
            <input type="date" class="form-control form-control-solid" placeholder="تاريخ البداية " name="start_date"/>
        </x-form.input>
        <x-form.input class="col-sm-6" title="تاريخ النهاية " :required="true">
            <input type="date" class="form-control form-control-solid" placeholder="تاريخ النهاية " name="end_date"/>
        </x-form.input>

        <x-form.input class="col-sm-6" title="خصم براند 1" :required="true">
            <input type="text" class="form-control form-control-solid numbersOnly" placeholder="خصم براند 1" name="brand1_discount"/>
        </x-form.input>
        <x-form.input class="col-sm-6" title="خصم براند 2" :required="true">
            <input type="text" class="form-control form-control-solid numbersOnly" placeholder="خصم براند 2" name="brand2_discount"/>
        </x-form.input>
